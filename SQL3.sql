...
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 1),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 54),
    TO_DATE('26/02/2006 09:00:00','DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('26/02/2006 12:00:00','DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 1),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 59),
    TO_DATE('25/02/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('25/02/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 2),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 57),
    TO_DATE('24/02/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('24/02/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 2),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 59),
    TO_DATE('23/02/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('24/02/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 3),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 60),
    TO_DATE('09/04/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('09/04/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
(SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 3),
(SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 65),
TO_DATE('06/04/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
TO_DATE('08/04/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 4),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 62),
    TO_DATE('14/05/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('14/05/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 4),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 66),
    TO_DATE('14/05/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('14/05/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 5),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 56),
    TO_DATE('22/02/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('25/02/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
...
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 6),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 53),
    TO_DATE('03/03/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('04/03/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 6),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 57),
    TO_DATE('04/03/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('04/03/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 7),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 55),
    TO_DATE('09/04/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('09/04/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
...
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 8),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 54),
    TO_DATE('12/05/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('12/05/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 8),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 62),
    TO_DATE('11/05/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('12/05/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 9),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 59),
    TO_DATE('22/02/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('22/02/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 9),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 60),
    TO_DATE('22/02/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('22/02/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 10),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 63),
    TO_DATE('09/04/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('09/04/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
...
INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 10),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 67),
    TO_DATE('08/04/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('09/04/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 11),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 59),
    TO_DATE('09/03/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('11/03/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 11),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 64),
    TO_DATE('09/03/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('17/03/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 11),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 53),
    TO_DATE('08/03/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('16/03/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 12),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 55),
    TO_DATE('05/05/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('05/05/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 12),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 56),
    TO_DATE('03/05/2006 09:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('05/05/2006 12:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 13),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 64),
    TO_DATE('12/05/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('12/05/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);

INSERT INTO intervenants VALUES (
    (SELECT REF(i) FROM interventions i WHERE i.NUMINTERVENTION = 14),
    (SELECT REF(e) FROM employe e WHERE e.NUMEMPLOYE = 88),
    TO_DATE('07/05/2006 14:00:00', 'DD/MM/YYYY HH24:MI:SS'),
    TO_DATE('10/05/2006 18:00:00', 'DD/MM/YYYY HH24:MI:SS')
);
...
DECLARE
  v_ref REF tclient;
BEGIN
  FOR rec IN (SELECT c.NUMCLIENT, v.NUMVEHICULE
              FROM client c, vehicule v
              WHERE v.client = (SELECT REF(c) FROM client c2 WHERE c2.NUMCLIENT = c.NUMCLIENT))
  LOOP
    SELECT REF(c) INTO v_ref FROM client c WHERE c.NUMCLIENT = rec.NUMCLIENT;
    UPDATE TABLE (SELECT c.client_vehicule FROM client c WHERE c.NUMCLIENT = rec.NUMCLIENT)
      SET VALUE = (SELECT REF(v) FROM vehicule v WHERE v.NUMVEHICULE = rec.NUMVEHICULE)
      WHERE VALUE IS NULL;
  END LOOP;
END;
/
